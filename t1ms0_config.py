...
from connectionConfig import PBclk, laser, start_trig, samp_clk, conv_clk, MW, camera
...
Nsamples = 15              # Number of FL samples to take at each scan point
...
MW_freq = 2850 /1e3 * GHz     # Microwave frequency (Hz)
t_pi = 120 *ns
