...
class Dcamapi:
    ...
    def init(cls, *initparams):
        """Initialize DCAM-API.
        Initialize DCAM-API.
        Do not call this when Dcam object exists because constructor of Dcam execute this.
...
class Dcam:
    ...
    def buf_getframedata(self, iFrame):
        ...
        return ret[1]       # only the data is returned
        # need to return 'aFrame' if the metadata is also required
