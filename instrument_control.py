...
class Instruments():
    @abstractmethod
    def change_parameter(self, parameter_name: str, new_value):
        pass

class signalgenerator(Instruments):
    def __init__(self) -> None:
        self.commadd = ''
        self.amlitude = 0      # in dBm
        self.freq = 0           # in Hz
        self.modtype = 0
        
    def init_sg(self,serialaddr='5',modelName='SG384'):
        """
